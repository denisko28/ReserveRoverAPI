...
public class PlacesDescriptionsSeeder : ISeeder<PlacesDescription>
{
    private static readonly List<PlacesDescription> PlacesDescriptions = new()
    {
        new PlacesDescription
        {
            PlaceId = 1,
    ...
    public void Seed(EntityTypeBuilder<PlacesDescription> builder)
    {
