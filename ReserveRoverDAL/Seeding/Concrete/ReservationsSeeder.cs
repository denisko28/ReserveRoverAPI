...
public class ReservationsSeeder : ISeeder<Reservation>
{
    private static readonly List<Reservation> Reservations = new()
    {
        new Reservation
        {
            ...
            TableId = 1,
            UserId = "U1",
            ReservDate = DateOnly.Parse("2023-04-12"),
        ...
        new Reservation
        {
            ...
            UserId = "U2",
            ReservDate = DateOnly.Parse("2023-04-12"),
            BeginTime = TimeOnly.Parse("16:30:00"),
            EndTime = TimeOnly.Parse("19:30:00"),
            PeopleNum = 2,
            Status = 1,
        ...
        new Reservation
        {
            ...
            TableId = 1,
            UserId = "U4",
            ReservDate = DateOnly.Parse("2023-04-22"),
            BeginTime = TimeOnly.Parse("14:00:00"),
            EndTime = TimeOnly.Parse("16:00:00"),
            PeopleNum = 2,
            Status = 0,
        ...
        new Reservation
        {
            ...
            UserId = "U5",
            ReservDate = DateOnly.Parse("2023-04-22"),
            BeginTime = TimeOnly.Parse("17:00:00"),
